...
Le fichier distribuable est créé dans `artifacts\installer\PersonalAppsHub-Setup-1.0.0-x64.exe`. Pour publier une autre version, utilisez par exemple `-Version 1.1.0`.
